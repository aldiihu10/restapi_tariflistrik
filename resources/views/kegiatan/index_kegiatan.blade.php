...
<body>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<form action="{{route('rekappdf.kegiatan')}}" enctype="multipart/form-data">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="{{route('rekappdf.kegiatan')}}" target="_blank" enctype="multipart/form-data">
							{{ csrf_field() }}
							<table>
								<tr>
									<td>
									...
									<td>
										<div class="form-group">
											<input type="date" class="form-control" name="tgl_awal" value="{{ date('Y-m-d') }}" required>
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											<input type="date" class="form-control" name="tgl_akhir" value="{{ date('Y-m-d') }}" required>
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td></td>
									<td>
										<input type="submit" class="btn btn-primary" name="rekap_data" value="Cetak">
									</td>
								</tr>
							</table>
						</form>
	...
	<div class="wrapper">
		<div class="sidebar" data-color="purple" data-image="{{asset('dashboard/assets/img/side-3.jpg')}}">
							...
							<div class="col-md-12">
								<div class="card">
									...
									<div class="header" style="margin-bottom: 50px;">
										<div>
											<a href="{{route('create.kegiatan')}}" class="btn btn-info btn-fill pull-left" style="margin-right: 5px; margin-top: 5px;">
												Tambah Data
											</a>
										</div>
									...
									<div class="content table-responsive table-full-width">
										<table class="table table-hover table-striped">
											<thead>
												...
												<th><center>Destinasi / Lokasi</center></th>
												<th><center>Acara / Kegiatan</center></th>
											...
											<tbody>
												...
												<tr>
													<td>
														<a href="{{route('show.kegiatan.edit', $data->id)}}">
													...
													<td>
														<center>{{$data->destinasi}}</center>
													</td>

													<td>
														<center>{{$data->acara}}</center>
													</td>

													<td>
														<center>{{$data->penyelenggara}}</center>
													</td>

													<td>
														<center>{{$data->total_pengunjung}}</center>
													</td>
													...
													<td>
														<div class="btn-group dropdown">
															...
															<ul class="dropdown-menu">
																<li>
																	<a href="{{ route('cetakpdf.kegiatan', $data->id) }}" class="pe-7s-print">
																		&nbsp&nbsp Print
																	</a>
																</li>

																<li>
																	<a href="{{ route('delete.kegiatan', $data->id) }}" onclick="return confirm('Anda yakin ingin menghapus data ini?')" class="pe-7s-trash">
																		&nbsp&nbsp Delete
																	</a>
																</li>
															</ul>
